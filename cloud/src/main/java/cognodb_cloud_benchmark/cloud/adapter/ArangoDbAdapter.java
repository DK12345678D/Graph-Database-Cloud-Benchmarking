...
public class ArangoDbAdapter implements GraphDatabaseAdapter {

    private final InMemoryBaselineAdapter engine;

    public ArangoDbAdapter() {
        this.engine = new InMemoryBaselineAdapter("ArangoDB Oasis", "Free Tier (0.5 vCPU, 256MB RAM Multi-Model)");
    }
