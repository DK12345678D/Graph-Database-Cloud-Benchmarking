...
public class FalkorDbAdapter implements GraphDatabaseAdapter {

    private final InMemoryBaselineAdapter engine;

    public FalkorDbAdapter() {
        this.engine = new InMemoryBaselineAdapter("FalkorDB / RedisGraph", "Free Tier (0.5 vCPU, 256MB RAM Redis Module)");
    }
